												...
												<fieldset>
													<label class="block clearfix">
														<span class="block input-icon input-icon-right">
                                                            <asp:TextBox ID="txtUsernameLogin" type="text" class="form-control" placeholder="Username" runat="server"></asp:TextBox>
													...
													<label class="block clearfix">
														<span class="block input-icon input-icon-right">
                                                            <asp:TextBox ID="txtPasswordLogin" type="password" class="form-control" placeholder="Password" runat="server"></asp:TextBox>
												...
												<fieldset>
													<label class="block clearfix">
														<span class="block input-icon input-icon-right">
                                                            ...
                                                            <asp:TextBox ID="txtEmailRegister" type="email" class="form-control" placeholder="lalala" runat="server"></asp:TextBox>
										...
										<div class="widget-main">
											...
											<p> Enter your details to begin: </p>
												...
												<fieldset>
													...
													<label class="block clearfix">
														<span class="block input-icon input-icon-right">
                                                            <asp:TextBox ID="txtUsernameRegistro" type="text" class="form-control" placeholder="Username" runat="server"></asp:TextBox>
													...
													<label class="block clearfix">
														<span class="block input-icon input-icon-right">
                                                            <asp:TextBox ID="txtPasswordRegistro" type="password" class="form-control" placeholder="Password" runat="server"></asp:TextBox>
